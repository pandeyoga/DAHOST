...
def main() -> int:
    ...
    if not item:
        ...
        # Item hasil impor master menyimpan `account_id` langsung (tanpa catalog_id).
        aid = cat.get("account_id") or item.get("account_id")
        ...
        payload = {
            "account_id": aid, "platform": cat.get("platform") or item.get("platform") or "manual",
