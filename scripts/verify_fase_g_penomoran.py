...
def part_runtime(db, restore_cfg):
    ...
    if st_pol != 200:
        ...
        return
    # 2026-09-23 — keputusan owner: bawaan PO produksi OTOMATIS (dulu manual).
    if pol.get("mode_default") != "auto":
        bad("G1", f"bawaan mode PO produksi = {pol.get('mode_default')} (harusnya auto)",
            "keputusan owner 2026-09-23: semua nomor Produksi & Maklon otomatis")
    else:
        ok("G1", "kebijakan dibaca staf pembuat dokumen; bawaan PO produksi OTOMATIS",
