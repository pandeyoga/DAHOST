...
def main():  # noqa: C901
    ...
    SJ_OK = test_doc_number("vendor_shipments.shipment_number", adm)
    st, sj = call("POST", "/api/vendor-shipments", adm, {
        "vendor_id": vendor["id"], "shipment_number": SJ_OK,
    ...
    if not b2:
        ...
        SJ_OVER = test_doc_number("vendor_shipments.shipment_number", adm, band=9500)
        st2, d2 = call("POST", "/api/vendor-shipments", adm, {
            "vendor_id": vendor["id"], "shipment_number": SJ_OVER,
    ...
    if not mk:
        ...
        sjno = test_doc_number("vendor_shipments.shipment_number", adm, band=9800)
