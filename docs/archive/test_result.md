      ...
      - working: false
        ...
        comment: |
          ...
          **YANG PERLU DITEST (comprehensive, semua wajib):**
          ...
          URL preview: `REACT_APP_BACKEND_URL` di `frontend/.env` (https://backend-test-suite-6.preview.emergentagent.com).
    ...
    status_history:
        - working: "NA"
          ...
          comment: |
            ...
            MDL-SWEATER-DEMO "Sweater Demo Klasik" id=backend-test-suite-6),
