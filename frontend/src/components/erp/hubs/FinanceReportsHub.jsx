...
const RahazaFGValuationModule   = lazyRetry(() => import('../RahazaFGValuationModule'));
const RahazaWorksheetModule     = lazyRetry(() => import('../finance/RahazaWorksheetModule'));
const RahazaPnLMonthlyModule    = lazyRetry(() => import('../finance/RahazaPnLMonthlyModule'));
const RahazaBalanceSheetMonthlyModule = lazyRetry(() => import('../finance/RahazaBalanceSheetMonthlyModule'));
