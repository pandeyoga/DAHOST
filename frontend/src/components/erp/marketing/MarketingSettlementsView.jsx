  ...
  return (
    <div className="space-y-4" data-testid="marketing-settlements-view">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-foreground/60 mt-0.5">
            Dana yang <b>dilepas platform ke saldo toko</b> (Shopee/TikTok) beserta potongannya —
            inilah yang masuk Finance sebagai piutang toko, lalu ditarik ke bank. Omzet dari
            input sales tidak ikut ke sini. <b>Marketing hanya melihat</b> — pencatatan & jurnal
            di <b>Portal Keuangan → Kas, Bank & Biaya → Saldo & Pencairan Marketplace</b>.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <Kpi testId="settlement-kpi-net" icon={Banknote} label="Total masuk saldo platform"
          value={rp(summary?.net_payout || 0)} tone="good"
          hint={`${rows.length} laporan dana dilepas`} />
