...
const ModuleHelpDrawer = lazyRetry(() => import('./userGuide/ModuleHelpDrawer'));
const ModuleTour = lazyRetry(() => import('./userGuide/ModuleTour'));
const UserGuideDialog = lazyRetry(() => import('./userGuide/UserGuideDialog'));
...
const UniversalScanPortal = lazyRetry(() => import('./scanner/UniversalScanPortal'));
