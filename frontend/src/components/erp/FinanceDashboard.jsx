...
const QUICK_LINKS = [
  ...
  { id: 'fin-marketplace-settlement', label: 'Saldo & Pencairan Marketplace', desc: 'Dana dilepas ke saldo toko, potongan platform & penarikan ke bank.', icon: Banknote, group: 'penerimaan' },
