...
const LEGACY_MODULE_TO_PORTAL = {
  ...
  'prod-bom': 'rnd',            // 2026-09-12 (owner): BOM & Ukuran pindah ke Portal RnD → Master Produk
  'prod-sizes': 'rnd',
  'rnd-master-product-hub': 'rnd',
  'rnd-bom': 'rnd', 'rnd-sizes': 'rnd', 'rnd-colors': 'rnd', 'rnd-categories': 'rnd', 'rnd-sku-variants': 'rnd',
