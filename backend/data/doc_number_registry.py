...
DOC_NUMBER_REGISTRY = [
    ...
    # SESI 2026-09-23 #11 — keputusan owner: SEMUA nomor Produksi & Maklon otomatis.
    # Bawaan dipindah manual → auto; nomor PO lama tidak disentuh.
    {"key": "production_pos.po_number", "label": "PO Produksi Internal (SPP)", "group": "Produksi",
     "policy_enforced": True,
     "default_format": "PO-INT-{YYYY}{MM}-{SEQ:4}", "tokens": [], "default_mode": "auto",
     "catatan": "Dipakai juga sebagai nomor SPP. Bawaan OTOMATIS (keputusan owner "
                "2026-09-23); ubah ke manual bila nomor perlu diketik — tetap wajib "
                "mengikuti pola ini."},
    {"key": "vendor_shipments.shipment_number", "label": "Shipment Vendor (Kirim Material ke CMT)",
     "group": "Produksi", "policy_enforced": True,
     "default_format": "SHP-{YYYY}{MM}-{SEQ:4}", "tokens": [], "default_mode": "auto",
     "catatan": "Surat jalan material dari DA ke vendor CMT (Portal Produksi → Kirim "
                "Material). Dulu diketik bebas (SHP-2025-001) — sejak 2026-09-23 lewat "
                "kebijakan penomoran. Surat jalan PENGGANTI (child) memakai nomor induk "
                "+ akhiran, tidak lewat seri ini."},
    ...
    {"key": "rahaza_customers.code", "label": "Kode Pelanggan", "group": "SKU / Kode Master",
     "policy_enforced": True,
     "default_format": "CUST-{SEQ:4}", "tokens": [],
     "catatan": "Master pelanggan (Penjualan Langsung / AR). Mode otomatis: kode dibuat sistem; "
                "mode manual: kode ketikan wajib mengikuti format."},
