...
async def list_products(request: Request,
    ...
    from core.stock_schema import read_qty  # RND-02: SSOT stok = rahaza_material_stock (rahaza_stock tidak pernah ditulis)
    stock = await db.rahaza_material_stock.find({"material_id": {"$in": ids}},
                                                {"_id": 0, "material_id": 1, "qty": 1, "total_qty": 1, "quantity": 1}).to_list(5000)
    stock_by_mat: dict = {}
    for s in stock:
