...
REGISTRY = {
    ...
    "coa_accounts": {
        ...
        "columns": [
            col("code", "str", True, example="1-1101"), col("name", "str", True, example="Kas"),
            col("type", "str", True, example="ASSET"), col("parent_code", "str", example="1-1100"),
    ...
    "boms": {
        ...
        "key": ["model_id", "size_id", "color"], "importable": True, "export_roles": ["spv", "produksi"],
