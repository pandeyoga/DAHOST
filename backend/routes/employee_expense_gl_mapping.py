...
from core.roles import FINANCE_ROLES as ADMIN_ROLES  # T-08
...
DEFAULT_GL_SEED = {
    # FIN-21 (temuan 2026-09-23): kode disamakan dengan bagan akun standar rahaza_coa.py
    # (6-3300 = BPJS TK, 6-3600+ tidak ada). Perjalanan → 6-3400, reimbursement → 6-3500, umum → 6-2900.
    'Transportasi':                  ('6-3400', 'Biaya Perjalanan Dinas'),
    'Akomodasi':                     ('6-3400', 'Biaya Perjalanan Dinas'),
    'Konsumsi / Makan':              ('6-3500', 'Biaya Reimbursement Karyawan'),
    'Representasi / Entertainment':  ('6-3500', 'Biaya Reimbursement Karyawan'),
    'Komunikasi':                    ('6-2300', 'Telepon & Internet'),
    'ATK / Perlengkapan':            ('6-2400', 'ATK & Supplies'),
    'Parkir / Tol':                  ('6-3400', 'Biaya Perjalanan Dinas'),
    'Biaya Training / Seminar':      ('6-3500', 'Biaya Reimbursement Karyawan'),
    'Biaya Kesehatan':               ('6-3500', 'Biaya Reimbursement Karyawan'),
    'Sewa Kendaraan':                ('6-3400', 'Biaya Perjalanan Dinas'),
    'Perbaikan / Maintenance':       ('6-2900', 'Beban Umum & Lain-lain'),
    'Biaya Pengiriman / Kurir':      ('6-2900', 'Beban Umum & Lain-lain'),
    'Lain-lain':                     ('6-2900', 'Beban Umum & Lain-lain'),
}
