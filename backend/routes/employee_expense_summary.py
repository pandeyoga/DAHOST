...
from core.roles import APPROVER_ROLES  # T-08
import logging
...
async def pending_approval_list(
    ...
    for t in travel:
        ...
        items.append({
            ...
            'cash_advance_requested': t.get('cash_advance_requested', 0) or 0,  # FIN-12: inbox menyetujui uang muka yang diminta, bukan anggaran total
            'status': t.get('status'),
