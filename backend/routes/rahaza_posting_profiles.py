...
DEFAULT_PROFILES = [
    ...
    },
    {
        ...
        "mapping": {
            ...
            "debit_cmt_expense_internal": "5-2200",  # dipakai HANYA bila debit_cmt_wip_internal kosong
            "debit_cmt_expense_maklon": "5-4200",    # Biaya Vendor CMT – Maklon (biaya proyek klien)
            "credit_ap": "2-1100",
