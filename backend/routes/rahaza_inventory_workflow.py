...
async def confirm_mi(mid: str, request: Request):  # noqa: C901
    ...
    # PROD-01 (temuan 2026-09-23): jalur potong stok kedua tanpa persetujuan DITUTUP.
    raise HTTPException(410, "Jalur 'Konfirmasi & Kurangi Stok' (tanpa approval) sudah dimatikan. "
                             "Gunakan Ajukan Approval → Approve (POST /submit lalu /approve).")
    db = get_db()
